...
# Определяем словари с очками для букв
...
# Определяем, является ли слово русским или английским
if all(ord(c) < 128 for c in word):
    scores = scores_eng  # английский алфавит
else:
    scores = scores_rus  # русский алфавит

# Считаем сумму очков за слово
score = sum(scores.get(letter.upper(), 0) for letter in word)

# Выводим результат
print('Строим слово "{}" и получаем {} очков.'.format(word, score))
